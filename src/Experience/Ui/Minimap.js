...
export default class Minimap {
  ...
  setMinimap() {
    ...
    // Minimap Highlight
    this.minimapHighlight = this.model.getObjectByName(
      'minimapHighlight'
    )
  ...
  setMinimapPosition() {
    this.minimapGroup.position.set(
      0,
      -this.experience.sizes.height * 0.5 + 30,
      -50
    )
  }
  ...
  setTimelineButton() {
    ...
    this.minimapIn = gsap
      ...
      .fromTo(
        this.minimapOffset.position,
        { y: -100 },
        { duration: 0.5, y: 0, ease: 'power2.inOut' },
        '<'
      )
  }
  ...
  update() {
    ...
    const currentOctaveStartX =
      this.MINIMAP_START_C2 + octaveOffset * this.MINIMAP_OCTAVE
